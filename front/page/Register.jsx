...
function Register() {
    ...
    const handleSumbit = (e)=>{
        ...
        axios("http://localhost:3000/api/register", values)
    ...
    return (
        <div className="container">
            ...
            <form onSubmit={handleSumbit}>
                <div className="mb-3">
                    <label htmlFor="emai" className="form-label">Correo electrónico</label>
                    <input type="email"
                ...
                <div className="mb-3">
                    <label htmlFor="password-confirmation" className="form-label">Confirmacion de contraseña</label>
                    <input type="password"
                        className="form-control"
                        id="`password_confirmation" 
                        name="password_confirmatiom"
                        value={values.password_confirmatiom}
                        onChange={handleChange}
                        required
                        minLength={5}/>
                </div>
